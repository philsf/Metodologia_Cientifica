...
\begin{frame}{Objetivos, usos e abusos}
  \begin{itemize}
  \item Fator de Impacto (JIF): Journal Impact Factor
...
\begin{frame}{O Journal Impact Factor (JIF)}
  \begin{definition}
    \begin{displaymath}
      JIF = \frac{\text{\#citações}}{\text{\#citáveis}}
    \end{displaymath}
  \end{definition}
  \begin{itemize}
...
\begin{frame}{Número de citações}
  ...
  \end{itemize}
  \begin{example}[JIF de 2009]
    Citações em 2009 de publicações de 2007 + 2008
  \end{example}
\end{frame}

\begin{frame}{Número de artigos citáveis}
São considerados citáveis:
  \begin{itemize}
  ...
  \begin{block}{Desconsiderados}
    Comentários, cartas, editoriais, obituários, \ldots
  \end{block}
\end{frame}
...
\begin{frame}{Exemplo}
  \begin{example}[Fator de Impacto de 2009]
    \begin{displaymath}
      JIF = \frac{\text{citações em 2009 de publicações de 2007 + 2008}}{\text{publicações de 2007 + 2008}}
    \end{displaymath}
  \end{example}
