...
\begin{frame}{Escolha do tema}
  \includegraphics[width=\textwidth]{delimitacao1}

  \includegraphics[width=\textwidth]{delimitacao2}
\end{frame}
...
\begin{frame}{Humor 2}
  \includegraphics[width=\textwidth]{olympus-abs}
