...
\begin{frame}{\scriptsize Padronização da página}
  \begin{itemize}
    \footnotesize
  \item Papel: A4
    \medskip
...
\begin{frame}{\scriptsize Numeração de seções}
  \begin{center}
...
% \begin{frame}{\scriptsize Quadros e Tabelas}
%   \begin{itemize}
%     \footnotesize
...
\begin{frame}{\scriptsize Lista de abreviaturas}
  ...
  \item Indicar \alert{todas} as abreviaturas utilizadas no texto
    % \footnote{mesmo que uma única vez}
    \bigskip
