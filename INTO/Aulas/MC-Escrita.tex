...
\begin{frame}{Voz passiva x ativa}
  \begin{exampleblock}{Passiva}
    \footnotesize
    O tratamento com a droga, nas doses usadas aqui, que garantiram melhoria na sobrevida e diminuição na taxa de eventos adversos, incluindo eventos SNC e não-SNC, pareceu ter eficácia comparável a outras drogas desta classe.
  ...
  \begin{exampleblock}{Ativa}
    \footnotesize
    Nas doses usadas aqui, o tratamento com a droga teve eficácia comparável a outras drogas desta classe.
    Este também demonstrou melhoria na sobrevida e uma redução na taxa de eventos adversos, incluindo eventos SNC e não-SNC.
