...
\begin{frame}{Exercício 1: Que pergunta este gráfico lhe motiva?}
  \begin{center}
    \includegraphics[height=.9\textheight]{EDA/EDA-corr1}
  \end{center}
\end{frame}

\begin{frame}{Exercício 2: O Gênero parece influenciar?}
  \begin{center}
    \includegraphics[height=.9\textheight]{EDA/EDA-corr2}
  \end{center}
\end{frame}

\begin{frame}{Exercício 3: E a idade?}
  \begin{center}
