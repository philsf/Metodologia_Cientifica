...
\begin{frame}{Muito trabalho}
  \begin{enumerate}
    \scriptsize
  \item A pesquisa médica na mídia
  \item Proposta de estudo 1/2
  \item Elaboração de uma pergunta PICO
  \item Posição de tópico, posição de ênfase
  \item Proposta de estudo 2/2
  \item Protocolo de pesquisa
  \item Citações in loco
  \item Relatório: Introdução + Métodos + Referências
  \item Relatório: Resultados
  \item Relatório: discussão + padronização da formatação + sumários
  \item Relatório: resumo
  \item Apresentação + relatório final
  \end{enumerate}
\end{frame}
