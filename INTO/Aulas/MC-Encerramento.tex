...
\begin{frame}{Muito trabalho}
  ...
  \begin{center}
    \visible<1>{\footnotesize Você {\bf experimentou} as etapas do método científico}

    \visible<2>{Formulação do Problema de Pesquisa}
  
    \visible<3>{Planejamento da Pesquisa}
  
    \visible<4>{Execução + Comunicação}
