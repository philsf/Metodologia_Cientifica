...
%   \includegraphics[width=\textwidth]{Planejamento/delimitacao1}

%   \includegraphics[width=\textwidth]{Planejamento/delimitacao2}
% \end{frame}
...
\begin{frame}{Pequeno...}
  \includegraphics[width=\textwidth]{Planejamento/cronograma-1}
\end{frame}

\begin{frame}{Médio...}
  \includegraphics[width=\textwidth]{Planejamento/cronograma-2}
\end{frame}
...
\subsection[SAP]{Plano analítico}

\begin{frame}{Plano analítico}
...
\begin{frame}{Plano analítico -- SAP}
  \begin{exampleblock}{Exemplo}
    \centering
...
\begin{frame}{Plano analítico -- SAP}
  \begin{exampleblock}{Exemplo}
    \centering
    \includegraphics[height=.8\textheight]{Planejamento/CRASH-SAP4}
...
\begin{frame}{E mesmo planejando...}
  \centering
  \includegraphics[width=\textwidth]{Planejamento/plano-realidade}
\end{frame}
...
\begin{frame}{Aprofundamento}
  ...
  \begin{block}{Leitura recomendada}
    \begin{exampleblock}{\tiny Exemplos de protocolos de revisão sistemática}
      \begin{itemize}
        \tiny
    ...
    \begin{itemize}
      \tiny
    \item \href{http://plataformabrasil.saude.gov.br/}{MANUAL DE ORIENTAÇÃO: PENDÊNCIAS FREQUENTES EM PROTOCOLOS DE PESQUISA CLÍNICA -- Plataforma Brasil}
    \end{itemize}
  \end{block}
\end{frame}
