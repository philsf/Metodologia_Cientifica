...
\maketitle
\abstract{
Nesta avaliação parcial, o discente deverá redigir um texto dissertativo que simule um projeto de pesquisa.
Caberá aos alunos (a) formular um problema de pesquisa, (b) indicar que tipos de dados deverão ser coletados para responder às questões levantadas, (c) justificar suas escolhas, preferencialmente com algumas referências bibliográficas.
